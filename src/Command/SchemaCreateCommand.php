...
final class SchemaCreateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            SchemaInstaller::create($dsn === null ? ($this->connection)() : Database::connect($dsn, $input->getOption('user'), $input->getOption('password')), catalog: $polaris?->graph()->permissionCatalog());
